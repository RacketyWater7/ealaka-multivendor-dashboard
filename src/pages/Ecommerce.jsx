...
const Ecommerce = () => {
  ...
  return (
    <div className="mt-16 mr-5">
      <p className="pl-8" style={{ color: `${currentColor}` }}>Good Morning, Maria Stephan</p>
      <p className="pl-8" style={{ color: `${secondaryColor}` }}>Here&apos;s what&apos;s happening with your store today</p>
      ...
      <div className="md:w-full overflow-auto">
        <ChartComponent
          ...
          legendSettings={{ background: 'white', position: 'Top', alignment: 'Far' }}
        >
      ...
      <div className="flex mt-6 ml-4 z-0">
        <div className="w-1/3">
          <p className="flex justify-between">
            <span style={{ color: `${currentColor}`, fontWeight: 'bold' }}>Top Supplier</span>
            <span style={{ color: `${secondaryColor}`, fontWeight: 'bold' }}>View All</span>
          </p>
          <GridComponent
            // className="z-0"
          ...
          >
            <ColumnsDirective>
              {/* eslint-disable-next-line react/jsx-props-no-spreading */}
              {employeesGrid1.map((item, index) => <ColumnDirective key={index} {...item} />)}
            </ColumnsDirective>
        ...
        <div className="ml-3 w-2/3">
          <p className="flex justify-between">
            <span style={{ color: `${currentColor}`, fontWeight: 'bold' }}>Recent Orders</span>
            <span style={{ color: `${secondaryColor}`, fontWeight: 'bold' }}>View All</span>
          </p>
          <GridComponent
          ...
          >
            <ColumnsDirective>
              {/* eslint-disable-next-line react/jsx-props-no-spreading */}
              {employeesGrid2.map((item, index) => <ColumnDirective key={index} {...item} />)}
            </ColumnsDirective>
            <Inject services={[Search, Page, CommandColumn]} />
          </GridComponent>
        </div>
      ...
      <div className="w-full mt-6 ml-4">
        <p className="flex justify-between">
          <span style={{ color: `${currentColor}`, fontWeight: 'bold' }}>Active Permotations</span>
          <span style={{ color: `${secondaryColor}`, fontWeight: 'bold' }}>View All</span>
        </p>
        <GridComponent
        ...
        >
          <ColumnsDirective>
            {/* eslint-disable-next-line react/jsx-props-no-spreading */}
            {employeesGrid3.map((item, index) => <ColumnDirective key={index} {...item} />)}
            <ColumnDirective headerText="Actions" width="90" commands={commands} />
          </ColumnsDirective>
          <Inject services={[Search, Page, CommandColumn]} />
        </GridComponent>
      </div>
