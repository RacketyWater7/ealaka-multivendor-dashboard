...
import { BiColorFill, BiCategory } from "react-icons/bi";
...
export const gridOrderStatus = (props) => (
  <div style={{ background: props.StatusBg }} className="rounded">
    <button type="button" className="text-white py-1 px-2 capitalize text-md">
      {props.Status}
    </button>
  </div>
);
const gridExpirationDate = (props) => {
  return (
    <div>
...
const deliveryGuysGridWallet = (props) => (
  <div className="border-1 pt-2 pb-2">{props.Revenue}</div>
);
const customerGridImage = (props) => (
  <div className="image flex gap-4">
    <img className="w-10 h-10" src={props.CustomerImage} alt="employee" />
    {/* <div>
...
const customerGridStatus = (props) => {
  ...
  if (props.Status === "Active" || props.Status === "Completed") {
    return (
      <div
        style={{ maxWidth: "100px", height: "32px", background: "#b4ffac" }}
        className="flex justify-center items-center"
      >
        <p style={{ color: "#26801c" }}>{props.Status}</p>
      </div>
    );
  }
  if (props.Status === "Cancel" || props.Status === "Deactivated") {
    return (
      <div
        style={{ maxWidth: "100px", height: "32px", background: "#ffc9dd" }}
        className="flex justify-center items-center"
      >
        <p style={{ color: "#cb2b65" }}>{props.Status}</p>
      </div>
    );
  }
  if (props.Status === "Pending") {
    return (
      <div
        ...
        className="flex justify-center items-center  bg-amber-200"
      >
        <p className="text-amber-800">{props.Status}</p>
      </div>
    );
...
const areaChartData = [
  [
    { x: new Date(2021, 0, 1), y: 200.2 },
    { x: new Date(2021, 1, 1), y: 800.4 },
    { x: new Date(2021, 2, 1), y: 500.8 },
    { x: new Date(2021, 3, 1), y: 100.6 },
    { x: new Date(2021, 4, 1), y: 600.3 },
    { x: new Date(2021, 5, 1), y: 700.5 },
    { x: new Date(2021, 7, 1), y: 500.9 },
    { x: new Date(2021, 8, 1), y: 300.8 },
    { x: new Date(2021, 9, 1), y: 600.4 },
    { x: new Date(2021, 10, 1), y: 200.1 },
  ],
  [
    { x: new Date(2021, 0, 1), y: 200.1 },
    { x: new Date(2021, 1, 1), y: 100.7 },
    { x: new Date(2021, 2, 1), y: 100.8 },
    { x: new Date(2021, 3, 1), y: 700.1 },
    { x: new Date(2021, 4, 1), y: 200.3 },
    { x: new Date(2021, 5, 1), y: 100.7 },
    { x: new Date(2021, 7, 1), y: 700.5 },
    { x: new Date(2021, 8, 1), y: 900.8 },
    { x: new Date(2021, 9, 1), y: 100.5 },
    { x: new Date(2021, 10, 1), y: 400.3 },
  ],
  [
    { x: new Date(2021, 0, 1), y: 400.8 },
    { x: new Date(2021, 1, 1), y: 400.3 },
    { x: new Date(2021, 2, 1), y: 900.1 },
    { x: new Date(2021, 3, 1), y: 100.6 },
    { x: new Date(2021, 4, 1), y: 400 },
    { x: new Date(2021, 5, 1), y: 100.7 },
    { x: new Date(2021, 7, 1), y: 200.3 },
    { x: new Date(2021, 8, 1), y: 800.7 },
    { x: new Date(2021, 9, 1), y: 400.1 },
    { x: new Date(2021, 10, 1), y: 400.3 },
  ],
  [
    { x: new Date(2021, 0, 1), y: 100.8 },
    { x: new Date(2021, 1, 1), y: 200.3 },
    { x: new Date(2021, 2, 1), y: 800.1 },
    { x: new Date(2021, 3, 1), y: 900.6 },
    { x: new Date(2021, 4, 1), y: 300 },
    { x: new Date(2021, 5, 1), y: 100.7 },
    { x: new Date(2021, 7, 1), y: 500 },
    { x: new Date(2021, 8, 1), y: 200.7 },
    { x: new Date(2021, 9, 1), y: 100.1 },
    { x: new Date(2021, 10, 1), y: 700.3 },
  ],
];
...
export const categoriesGrid = [
  { type: "checkbox", width: "50" },
  {
    ...
    template: categoryGridImage,
    textAlign: "Start",
    width: "70",
  },
  {
    headerText: "Category's Name",
    width: "120",
    field: "CategoryName",
    headerTextAlign: "Start",
    // template: customerGridImage,
...
export const categoriesData = [
  {
    ...
    CategoryImage: "/images/cat1.png",
    Status: "Active",
    StatusBg: "#8BE78B",
  },
  {
    CategoryName: "Kids Accessories",
    CategoryImage: "/images/cat2.png",
    Status: "Deactivated",
    StatusBg: "#8BE78B",
  },
  {
    CategoryName: "Fruits",
    CategoryImage: "/images/cat3.png",
    Status: "Active",
    StatusBg: "#8BE78B",
  },
  {
    CategoryName: "Food Stuff",
    CategoryImage: "/images/cat4.png",
    Status: "Deactivated",
    StatusBg: "#8BE78B",
  },
];
...
export const promotionsData = [
  {
    SupplierName: "Billie Brown ",
    ProductName: "Green Fresh Broccoli",
    ProductImage: "/images/broccoli.png",
    PromotionType: "Same Order",
    PromotionCategory: "Free Delivery",
